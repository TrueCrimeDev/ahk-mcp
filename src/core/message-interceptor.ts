...
export class MessageInterceptor {
  private static instance: MessageInterceptor;
  private lastDetectedFile: string | undefined;
  private autoSetActive: boolean = true;

  private constructor() {}

  static getInstance(): MessageInterceptor {
   ...
   */
  hasFilePath(message: string): boolean {
   ...
   */
  parseMultiLineMessage(message: string): {
    filePath?: string;
    instructions: string[];
    rawLines: string[];
  } {
   ...
   */
  getLastDetectedFile(): string | undefined {
