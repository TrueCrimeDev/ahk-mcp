...
import {
  AhkCloudAhkValidateTool,
  ahkCloudAhkValidateToolDefinition,
} from './tools/ahk-cloudahk-validate.js';
...
export class AutoHotkeyMcpServer {
  ...
  public ahkCloudAhkValidateToolInstance: AhkCloudAhkValidateTool;
